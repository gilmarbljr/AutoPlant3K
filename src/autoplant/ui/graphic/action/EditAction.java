...
public class EditAction extends javax.swing.JFrame {
     ...
     */
    public EditAction(OperationService operationService) {
    ...
    private void initComponents() {
        ...
        remover.setBackground(new java.awt.Color(195, 220, 195));
        ...
        alterar.setBackground(new java.awt.Color(195, 220, 195));
    ...
    private void alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarActionPerformed
        ...
        InsertAction action = new InsertAction(operationService, uc);
